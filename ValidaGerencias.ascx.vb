...
Partial Class ValidaGerencias
Inherits System.Web.UI.UserControl
'------------------------------------------------------------
' Código generado por ZRISMART SF el 13-04-2011 18:01:07
'------------------------------------------------------------
...
'----------------------------------------
Dim txtMasterName As Textbox ' Etiqueta : Código - Control : txtMasterName - Variable : GerenciasCodigo
'----------------------------------------
' Declaración de Campos de la Aplicación
'----------------------------------------
Dim GerenciasCodigo As String ' Etiqueta : Código - Control : txtMasterName - Variable : GerenciasCodigo
'----------------------------------------
...
Else
t = AccionesABM.MasterPartialInsert("GerenciasId", "GerenciasCodigo", "Gerencias", MasterName, CLng(Session("PersonaId")), MasterId)
Url = Url & "&Id=" & MasterId & "&MenuOptionsId=" & Request.QueryString("MenuOptionsId")
Response.Redirect(Url)
End If
Catch
