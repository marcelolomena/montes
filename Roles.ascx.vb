...
Partial Class Roles
    ...
    '------------------------------------------------------------
    ' Código generado por ZRISMART SF el 23-08-2010 11:52:56
    '------------------------------------------------------------
    ...
    '----------------------------------------
    Dim txtRolDescription As TextBox ' Etiqueta : Descripción - Control : txtRolDescription - Variable : RolDescription
    Dim txtRolName As TextBox ' Etiqueta : Rol - Control : txtRolName - Variable : RolName
    Dim txtRolNivel As TextBox
    '----------------------------------------
    ...
    Protected Sub RFC_Delete(ByVal sender As Object, ByVal e As System.EventArgs) Handles DeleteButton.Click
        ...
        Try
            t = Rol.RolDelete(Request.QueryString("Id"), CStr(txtRolName.Text), CLng(Session("PersonaId")), Mensaje)
            If t = False Then
    ...
    Protected Sub RFC_Update(ByVal sender As Object, ByVal e As System.EventArgs) Handles UpdateButton.Click
        ...
        Dim Rol As New Rol
        Try
            t = Rol.RolUpdate(Request.QueryString("Id"), CStr(txtRolName.Text), CStr(txtRolDescription.Text), CStr(txtRolNivel.Text), Session("PersonaId"))
        Catch
            t = 0
        End Try
        Response.Redirect(Url)
        ...
        If Not IsPostBack Then
            If Request.QueryString("Id") <> 0 Then
                If t = Rol.LeerRol(Request.QueryString("Id"), RolName, RolDescription, RolNivel) Then
                    ...
                    txtRolDescription = FindControl("txtRolDescription")
                    txtRolDescription.Text = RolDescription
                    txtRolNivel = FindControl("txtRolNivel")
                    txtRolNivel.Text = RolNivel
                    lblMensaje.Text = ""
                Else
                    txtRolName = FindControl("txtRolName")
                    txtRolName.Text = Session("RolName")
                End If
            End If
        Else
            txtRolName = FindControl("txtRolName")
