...
Partial Class BuscaTipoDoc
Inherits System.Web.UI.UserControl
'------------------------------------------------------------
' Código generado por ZRISMART SF el 26-01-2011 16:00:34
'------------------------------------------------------------
...
'----------------------------------------
Dim txtTipoDocName As DropDownList ' Etiqueta : Tipo de Documento - Control : txtTipoDocName - Variable : TipoDocName
'----------------------------------------
...
'----------------------------------------------------------------------------------------
Dim chktxtTipoDocName As CheckBox ' Etiqueta : Tipo de Documento - Control : txtTipoDocName - Variable : TipoDocName
'----------------------------------------
...
Dim sSQL As String = ""
If chktxtTipoDocName.Checked = True Then
If Len(sSQLWhere) = 0 Then
sSQLWhere = " Where TipoDocName = '" & txtTipoDocName.Text & "' "
Else
sSQLWhere = sSQLWhere & " AND TipoDocName = '" & txtTipoDocName.Text & "' "
End If
End If
If Len(sSQLWhere) > 0 Then
...
sSQL = "SELECT Count(*) AS Cantidad, Max(TipoDocId) AS Codigo FROM TipoDoc" & sSQLWhere
...
Url = Pagina & "?Pagina=" & Request.QueryString("Pagina") & "&SideBar=" & Request.QueryString("SideBar") & "&PaginaWebName=Ficha de TipoDoc&MenuOptionsId=" & Request.QueryString("MenuOptionsId") & "&Id=" & Codigo
...
chktxtTipoDocName = FindControl("chktxtTipoDocName")
End Sub
End Class
