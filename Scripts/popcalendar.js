	...
	*/
	...
	function init() {
		if (!ns4)
		{
			...
			sHTML1 = '<span id="spanLeft" style="border:1px solid #ffffff;cursor:pointer" onmouseover="swapImage(\'changeLeft\',\'left2.gif\');this.style.borderColor=\'#8af\';window.status=\''+scrollLeftMessage[language]+'\'" onclick="decMonth()" onmouseout="clearInterval(intervalID1);swapImage(\'changeLeft\',\'left1.gif\');this.style.borderColor=\'#ffffff\';window.status=\'\'" onmousedown="clearTimeout(timeoutID1);timeoutID1=setTimeout(\'StartDecMonth()\',500)" onmouseup="clearTimeout(timeoutID1);clearInterval(intervalID1)">&nbsp<img id="changeLeft" src="'+imgDir+'left1.gif" width="10" height="11" border="0">&nbsp</span>&nbsp;';
			...
			sHTML1 += '<span id="spanMonth" style="border:1px solid #ffffff;cursor:pointer" onmouseover="swapImage(\'changeMonth\',\'drop2.gif\');this.style.borderColor=\'#8af\';window.status=\''+selectMonthMessage[language]+'\'" onmouseout="swapImage(\'changeMonth\',\'drop1.gif\');this.style.borderColor=\'#ffffff\';window.status=\'\'" onclick="popUpMonth()"></span>&nbsp;';
			sHTML1 += '<span id="spanYear" style="border:1px solid #ffffff;cursor:pointer" onmouseover="swapImage(\'changeYear\',\'drop2.gif\');this.style.borderColor=\'#8af\';window.status=\''+selectYearMessage[language]+'\'" onmouseout="swapImage(\'changeYear\',\'drop1.gif\');this.style.borderColor=\'#ffffff\';window.status=\'\'" onclick="popUpYear()"></span>&nbsp;';
...
/*				if (ie){
					...
					crossobj.left = ctl.offsetLeft + leftpos  + fixedX + "px";
					crossobj.top = ctl.offsetTop + fixedY + toppos + ctl.offsetHeight + "px";
//				}
	...
	document.onkeypress = function hidecal1 (e) {
		...
		//if you don't use it like this it'll throw errors "event is not defined" in Firefox
	}
