...
Partial Class ValidaTipoDoc
Inherits System.Web.UI.UserControl
'------------------------------------------------------------
' Código generado por ZRISMART SF el 26-01-2011 16:05:28
'------------------------------------------------------------
...
'----------------------------------------
Dim txtMasterName As Textbox ' Etiqueta : Tipo de Documento - Control : txtMasterName - Variable : TipoDocName
'----------------------------------------
' Declaración de Campos de la Aplicación
'----------------------------------------
Dim TipoDocName As String ' Etiqueta : Tipo de Documento - Control : txtMasterName - Variable : TipoDocName
'----------------------------------------
...
Else
t = AccionesABM.MasterPartialInsert("TipoDocId", "TipoDocName", "TipoDoc", MasterName, CLng(Session("PersonaId")), MasterId)
Url = Url & "&Id=" & MasterId & "&MenuOptionsId=" & Request.QueryString("MenuOptionsId")
Response.Redirect(Url)
End If
Catch
