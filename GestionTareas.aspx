<%@ Page Language="VB" AutoEventWireup="false" CodeFile="GestionTareas.aspx.vb" Inherits="GestionTareas" %>
...
<head runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function OnCompleteImportanciaUpdate(arg) {
            window.returnValue = $get("txtUsuariosCodigo").value;
        ...
        function TerminarTarea() {
            ret = SimpleService.TerminarTarea($get("txtTareasCodigo").value, $get("txtUsuariosCodigo").value, $get("ddlEstadoTareasCodigo").value, $get("txtAccionesCodigo").value, OnCompleteImportanciaUpdate, OnTimeOutImportanciaUpdate, OnErrorImportanciaUpdate);
        }
...
<body>
    <form id="form1" runat="server">
        ...
        <table width="98%" class="visible" cellspacing="2" cellpadding="2" border="0" style="background-color:WhiteSmoke;border-color:WhiteSmoke;border-width:1px;border-style:Solid;">
            ...
            <tr valign="middle">
                <td class="textocontgris10bold" style="text-align:right;">Condición de término</td>
                <td width="71%" valign="middle" style="height:20px;">
                 <asp:DropDownList ID="ddlEstadoTareasCodigo" runat="server" width="500px"></asp:DropDownList>
