...
Partial Class BuscaAreas
Inherits System.Web.UI.UserControl
'------------------------------------------------------------
' Código generado por ZRISMART SF el 25-01-2011 9:46:45
'------------------------------------------------------------
...
'----------------------------------------
Dim txtAreasName As DropDownList ' Etiqueta : Área - Control : txtAreasName - Variable : AreasName
'----------------------------------------
...
'----------------------------------------------------------------------------------------
Dim chktxtAreasName As CheckBox ' Etiqueta : Área - Control : txtAreasName - Variable : AreasName
'----------------------------------------
...
sSQL = "SELECT Count(*) AS Cantidad, Max(AreasId) AS Codigo FROM Areas" & sSQLWhere
...
Url = Pagina & "?Pagina=" & Request.QueryString("Pagina") & "&SideBar=" & Request.QueryString("SideBar") & "&PaginaWebName=Ficha de Areas&MenuOptionsId=" & Request.QueryString("MenuOptionsId") & "&Id=" & Codigo
