...
Partial Class BuscaCargos
Inherits System.Web.UI.UserControl
'------------------------------------------------------------
' Código generado por ZRISMART SF el 18-04-2011 18:55:26
'------------------------------------------------------------
...
'----------------------------------------
Dim txtCargosName As DropDownList ' Etiqueta : Nombre - Control : txtCargosName - Variable : CargosName
    Dim txtAreasName As DropDownList ' Etiqueta : Gerencia - Control : txtGerenciasCodigo - Variable : GerenciasCodigo
'----------------------------------------
...
'----------------------------------------------------------------------------------------
Dim chktxtCargosName As CheckBox ' Etiqueta : Nombre - Control : txtCargosName - Variable : CargosName
    Dim chktxtAreasName As CheckBox ' Etiqueta : Gerencia - Control : txtGerenciasCodigo - Variable : GerenciasCodigo
'----------------------------------------
...
sSQLWhere = " Where CargosName = '" & txtCargosName.Text & "' "
Else
sSQLWhere = sSQLWhere & " AND CargosName = '" & txtCargosName.Text & "' "
End If
End If
        If chktxtAreasName.Checked = True Then
            If Len(sSQLWhere) = 0 Then
                sSQLWhere = " Where AreasName = '" & txtAreasName.Text & "' "
            Else
                sSQLWhere = sSQLWhere & " AND AreasName = '" & txtAreasName.Text & "' "
            End If
        End If
If Len(sSQLWhere) > 0 Then
...
chktxtCargosName = FindControl("chktxtCargosName")
        ...
        chktxtAreasName = FindControl("chktxtAreasName")
End Sub
End Class
