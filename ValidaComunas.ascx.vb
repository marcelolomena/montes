...
'----------------------------------------
Dim ComunasCodigo As String ' Etiqueta : Código Comuna - Control : txtMasterName - Variable : ComunasCodigo
'----------------------------------------
...
Else
t = AccionesABM.MasterPartialInsert("ComunasId", "ComunasCodigo", "Comunas", MasterName, CLng(Session("PersonaId")), MasterId)
Url = Url & "&Id=" & MasterId & "&MenuOptionsId=" & Request.QueryString("MenuOptionsId")
Response.Redirect(Url)
End If
Catch
