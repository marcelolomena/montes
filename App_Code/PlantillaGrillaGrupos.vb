...
Public Class PlantillaGrillaGrupos
    ...
    Private Sub FirstName_DataBinding(ByVal sender As Object, ByVal e As EventArgs)
        ...
        sSQL = sSQL & "WHERE (((Stakeholders.StakeholdersCodigo)='" & Valor & "'))"
        ...
        Try
            ...
            While dtr.Read
                i = i + 1
                If i = 1 Then
                    l.Text = l.Text & CStr(dtr("Grupo").ToString)
                Else
                    l.Text = l.Text & "<br />" & CStr(dtr("Grupo").ToString)
                End If
            End While
            dtr.Close()
        Catch
