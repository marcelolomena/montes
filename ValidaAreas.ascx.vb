...
Partial Class ValidaAreas
Inherits System.Web.UI.UserControl
'------------------------------------------------------------
' Código generado por ZRISMART SF el 25-01-2011 9:47:25
'------------------------------------------------------------
...
'----------------------------------------
    Dim txtMasterName As TextBox ' Etiqueta : Área - Control : txtAreasName - Variable : AreasName
'----------------------------------------
...
Else
t = AccionesABM.MasterPartialInsert("AreasId", "AreasName", "Areas", MasterName, CLng(Session("PersonaId")), MasterId)
Url = Url & "&Id=" & MasterId & "&MenuOptionsId=" & Request.QueryString("MenuOptionsId")
Response.Redirect(Url)
End If
Catch
