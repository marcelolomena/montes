...
Partial Class ValidaMoneda
Inherits System.Web.UI.UserControl
'------------------------------------------------------------
' Código generado por ZRISMART SF el 01-02-2011 11:23:32
'------------------------------------------------------------
...
'----------------------------------------
Dim txtMasterName As Textbox ' Etiqueta : Moneda - Control : txtMasterName - Variable : MonedaName
'----------------------------------------
' Declaración de Campos de la Aplicación
'----------------------------------------
Dim MonedaName As String ' Etiqueta : Moneda - Control : txtMasterName - Variable : MonedaName
'----------------------------------------
...
Else
t = AccionesABM.MasterPartialInsert("MonedaId", "MonedaName", "Moneda", MasterName, CLng(Session("PersonaId")), MasterId)
Url = Url & "&Id=" & MasterId & "&MenuOptionsId=" & Request.QueryString("MenuOptionsId")
Response.Redirect(Url)
End If
Catch
