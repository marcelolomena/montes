...
Partial Class BuscaProvincias
Inherits System.Web.UI.UserControl
'------------------------------------------------------------
' Código generado por ZRISMART SF el 29-08-2011 8:42:27
'------------------------------------------------------------
...
'----------------------------------------
Dim txtRegionesCodigo As DropDownList ' Etiqueta : Código Región - Control : txtRegionesCodigo - Variable : RegionesCodigo
'----------------------------------------
...
'----------------------------------------------------------------------------------------
Dim chktxtRegionesCodigo As CheckBox ' Etiqueta : Código Región - Control : txtRegionesCodigo - Variable : RegionesCodigo
'----------------------------------------
...
Dim sSQL As String = ""
If chktxtRegionesCodigo.Checked = True Then
If Len(sSQLWhere) = 0 Then
sSQLWhere = " Where RegionesCodigo = '" & txtRegionesCodigo.Text & "' "
Else
sSQLWhere = sSQLWhere & " AND RegionesCodigo = '" & txtRegionesCodigo.Text & "' "
End If
End If
If Len(sSQLWhere) > 0 Then
...
sSQL = "SELECT Count(*) AS Cantidad, Max(ProvinciasId) AS Codigo FROM Provincias" & sSQLWhere
...
Url = Pagina & "?Pagina=" & Request.QueryString("Pagina") & "&SideBar=" & Request.QueryString("SideBar") & "&PaginaWebName=Ficha de Provincias&MenuOptionsId=" & Request.QueryString("MenuOptionsId") & "&Id=" & Codigo
...
chktxtRegionesCodigo = FindControl("chktxtRegionesCodigo")
End Sub
End Class
