...
Partial Class BuscaRoles
    Inherits System.Web.UI.UserControl
    '------------------------------------------------------------
    ' Código generado por ZRISMART SF el 23-08-2010 12:00:14
    '------------------------------------------------------------
    ...
    Protected Sub RFC_Update(ByVal sender As Object, ByVal e As System.EventArgs) Handles UpdateButton.Click
        ...
        sSQL = "SELECT Count(*) AS Cantidad, Max(RolId) AS Codigo FROM Roles" & sSQLWhere
        ...
        Else
            If Cantidad = 1 Then    'Se pasa a la página que muestra la ficha de la única comuna seleccionada
                Url = Pagina & "?Pagina=" & Request.QueryString("Pagina") & "&SideBar=" & Request.QueryString("SideBar") & "&PaginaWebName=Ficha de Rol&MenuOptionsId=" & Request.QueryString("MenuOptionsId") & "&Id=" & Codigo
