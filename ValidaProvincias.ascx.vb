...
Partial Class ValidaProvincias
Inherits System.Web.UI.UserControl
'------------------------------------------------------------
' Código generado por ZRISMART SF el 29-08-2011 8:42:57
'------------------------------------------------------------
...
'----------------------------------------
Dim txtMasterName As Textbox ' Etiqueta : Código Provincia - Control : txtMasterName - Variable : ProvinciasCodigo
'----------------------------------------
' Declaración de Campos de la Aplicación
'----------------------------------------
Dim ProvinciasCodigo As String ' Etiqueta : Código Provincia - Control : txtMasterName - Variable : ProvinciasCodigo
'----------------------------------------
...
Else
t = AccionesABM.MasterPartialInsert("ProvinciasId", "ProvinciasCodigo", "Provincias", MasterName, CLng(Session("PersonaId")), MasterId)
Url = Url & "&Id=" & MasterId & "&MenuOptionsId=" & Request.QueryString("MenuOptionsId")
Response.Redirect(Url)
End If
Catch
