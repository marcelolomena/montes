...
Partial Class BuscaComunas
Inherits System.Web.UI.UserControl
'------------------------------------------------------------
' Código generado por ZRISMART SF el 29-08-2011 8:51:38
'------------------------------------------------------------
...
'----------------------------------------
Dim txtProvinciasCodigo As DropDownList ' Etiqueta : Código Provincia - Control : txtProvinciasCodigo - Variable : ProvinciasCodigo
'----------------------------------------
...
'----------------------------------------------------------------------------------------
Dim chktxtProvinciasCodigo As CheckBox ' Etiqueta : Código Provincia - Control : txtProvinciasCodigo - Variable : ProvinciasCodigo
'----------------------------------------
...
Dim sSQL As String = ""
If chktxtProvinciasCodigo.Checked = True Then
If Len(sSQLWhere) = 0 Then
sSQLWhere = " Where ProvinciasCodigo = '" & txtProvinciasCodigo.Text & "' "
Else
sSQLWhere = sSQLWhere & " AND ProvinciasCodigo = '" & txtProvinciasCodigo.Text & "' "
End If
End If
If Len(sSQLWhere) > 0 Then
...
sSQL = "SELECT Count(*) AS Cantidad, Max(ComunasId) AS Codigo FROM Comunas" & sSQLWhere
...
Url = Pagina & "?Pagina=" & Request.QueryString("Pagina") & "&SideBar=" & Request.QueryString("SideBar") & "&PaginaWebName=Ficha de Comunas&MenuOptionsId=" & Request.QueryString("MenuOptionsId") & "&Id=" & Codigo
...
chktxtProvinciasCodigo = FindControl("chktxtProvinciasCodigo")
End Sub
End Class
