...
Partial Class ValidaAcciones
Inherits System.Web.UI.UserControl
'------------------------------------------------------------
' Código generado por ZRISMART SF el 12-04-2011 13:32:55
'------------------------------------------------------------
...
'----------------------------------------
Dim txtMasterName As Textbox ' Etiqueta : Código - Control : txtMasterName - Variable : AccionesCodigo
'----------------------------------------
' Declaración de Campos de la Aplicación
'----------------------------------------
Dim AccionesCodigo As String ' Etiqueta : Código - Control : txtMasterName - Variable : AccionesCodigo
'----------------------------------------
...
MasterId = 0
t = Lecturas.LeerMasterIdByMasterName("AccionesId", "AccionesCodigo", "Acciones", MasterName, MasterId)
If MasterId > 0 Then
Url = Url & "&Id=" & MasterId & "&MenuOptionsId=" & Request.QueryString("MenuOptionsId")
Response.Redirect(Url)
Else
t = AccionesABM.MasterPartialInsert("AccionesId", "AccionesCodigo", "Acciones", MasterName, CLng(Session("PersonaId")), MasterId)
Url = Url & "&Id=" & MasterId & "&MenuOptionsId=" & Request.QueryString("MenuOptionsId")
Response.Redirect(Url)
End If
Catch
